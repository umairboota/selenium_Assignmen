...
public class ConfigReader {
	...
	public String getBaseUrl2() {
		if (config != null) {
			return config.getProperty("baseUrl2");
		}
		throw new IllegalStateException("Config not initialized");
	}
...
//  reading username from config file
	public String getUsername_task4() {
		return getConfigProperty("username_task4");
	}

//  reading username from config file
	public String getPassword_task4() {
		return getConfigProperty("password_task4");
	}
